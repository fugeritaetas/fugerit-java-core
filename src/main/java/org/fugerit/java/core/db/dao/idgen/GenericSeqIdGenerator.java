...
public class GenericSeqIdGenerator extends BasicSeqIdGenerator {
	...
	/* (non-Javadoc)
	 * @see org.fugerit.java.core.db.dao.idgen.BasicSeqIdGenerator#generateId()
	 */
	...
	/* (non-Javadoc)
	 * @see org.fugerit.java.core.db.dao.idgen.BasicSeqIdGenerator#configure(java.util.Properties)
	 */
