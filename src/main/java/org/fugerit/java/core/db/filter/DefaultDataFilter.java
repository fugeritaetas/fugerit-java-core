...
public class DefaultDataFilter extends BasicLogObject implements DataFilter {
	...
	/* (non-Javadoc)
	 * @see org.fugerit.java.core.db.filter.DataFilter#applyFilter(org.fugerit.java.core.db.connect.ConnectionFactory, java.lang.String, java.lang.String[], java.lang.String[])
	 */
	public void applyFilter(ConnectionFactory cf, String table, String[] columnsName, String[] columnsKeyName ) throws DAOException {
		...
		try {
			...
			while ( rs.next() ) {
				...
				this.getLogger().info( "update : "+result );
			}
		} catch (Exception e) {
			new DAOException( e );
		} finally {
	...
	/* (non-Javadoc)
	 * @see org.fugerit.java.core.db.filter.DataFilter#filter(java.lang.String[], java.lang.String[])
	 */
	...
	/* (non-Javadoc)
	 * @see org.fugerit.java.core.db.filter.DataFilter#query(org.fugerit.java.core.db.connect.ConnectionFactory, java.lang.String[])
	 */
	...
	/* (non-Javadoc)
	 * @see org.fugerit.java.core.db.filter.DataFilter#update(org.fugerit.java.core.db.connect.ConnectionFactory, java.lang.String, java.lang.String[], java.lang.String[])
	 */
	public int update(ConnectionFactory cf, String table, String[] columnsName, Object[] columnsValue , String[] columnsKeyName, Object[] columnsKeyValue ) throws DAOException {
		...
		try {
			...
			for ( int k=0; k<columnsValue.length; k++ ) {
				...
				this.getLogger().debug( "setting param "+count+" : "+columnsValue[k] );
				count++;
			}
			for ( int k=0; k<columnsKeyValue.length; k++ ) {
				ps.setObject( count , columnsKeyValue[k] );
				this.getLogger().debug( "setting param "+count+" : "+columnsKeyValue[k] );
				count++;
			}
