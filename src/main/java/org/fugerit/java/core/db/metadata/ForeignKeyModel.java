...
public class ForeignKeyModel  {
	 ...
	 * I valori sono le colonne corrispondenti nella tabella dove la foreign key à definita.
	 * 
	...
	/**
	 * <p>Restituisce l'elenco delle colonne interne per questo foreign key alla tabella in cui la chiave à definita.</p>
	 * 
	 * @param tableModel
	 * @return
	 */
