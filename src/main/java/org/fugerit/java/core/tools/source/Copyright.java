...
public class Copyright {
	...
	protected final static ResourceBundle CONFIG = ResourceBundle.getBundle( "org.fugerit.java.core.tools.source.copyright" );
...
class CopyrightFileFun extends AbstractFileFun {
	...
	/* (non-Javadoc)
	 * @see org.fugerit.java.core.io.file.AbstractFileFun#handleFile(java.io.File)
	 */
